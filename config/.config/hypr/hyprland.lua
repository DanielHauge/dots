...
hl.bind(
	mainMod .. " + S",
	hl.dsp.exec_cmd(
		[[pkill slurp || hyprshot -m ${1:-region} --raw | satty --filename - --early-exit --actions-on-enter save-to-clipboard --copy-command 'wl-copy']]
	)
)
...
hl.bind(mainMod .. " + ALT + left", hl.dsp.window.resize({ x = -200, y = 0, relative = true }))
hl.bind(mainMod .. " + ALT + right", hl.dsp.window.resize({ x = 200, y = 0, relative = true }))
hl.bind(mainMod .. " + ALT + up", hl.dsp.window.resize({ x = 0, y = -200, relative = true }))
hl.bind(mainMod .. " + ALT + down", hl.dsp.window.resize({ x = 0, y = 200, relative = true }))
